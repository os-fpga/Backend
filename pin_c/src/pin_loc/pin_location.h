...
public:
    ...
    struct PortInfo
    {
        ...
        uint16_t   range_lsb_  = 0;
        uint16_t   range_msb_  = 0;
  ...
  //void collect_left_available_device_pins(set<string> &constrained_device_pins,
  ...
  static bool read_port_info(std::ifstream& json_ifs,
