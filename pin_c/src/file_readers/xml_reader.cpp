...
//======================================================================
bool XmlReader::parse_io_cell (const pugi::xml_node xml_orient_io, const int row_or_col, const int io_per_cell, std::map<string, PinMappingData> *port_map)
{
...
//======================================================================
bool XmlReader::parse_io (const pugi::xml_node xml_io, const int width, const int height, const int io_per_cell, std::map<string, PinMappingData> *port_map)
{
...
bool XmlReader::read_xml(const string &f)
{
    ...
    if (!infile.is_open())
    {
        cerr << "ERROR: cound not open the file " << f << endl;
        return false;
    }
