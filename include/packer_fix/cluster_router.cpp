...
bool try_intra_lb_route(t_lb_router_data* router_data,
    ...
    // set iterations to 10 which is way enough. Generally it will succeed in no more than 1 or 2 
    // iterations. 10 generally will fail.
    // (T.Besson, for slight speed-up)
    //
    router_data->params.max_iterations = 10;
