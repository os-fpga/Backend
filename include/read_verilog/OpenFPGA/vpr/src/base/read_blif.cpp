...
public:
    ...
    {
        VTR_ASSERT(blif_format_ == e_circuit_format::BLIF || blif_format_ == e_circuit_format::EBLIF || blif_format_ == e_circuit_format::VERILOG || blif_format_ == e_circuit_format::EDIF);
