...
LogicVec StaWriterVisitor::load_lut_mask(
                        size_t num_inputs,   // LUT size
 ...
 */
vector<int> StaWriterVisitor::determine_lut_permutation(size_t num_inputs, const t_pb* atom_pb) {
  auto& atom_ctx = g_vpr_ctx.atom();
