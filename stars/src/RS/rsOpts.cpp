...
static const char* _ver_[] = {
  "V", "v", "ver", "vers", "version", nullptr };

static const char* _dev_ver_[] = {
  "DV", "VV", "vv", "dev_ver", "dev_version", nullptr };

static const char* _help_[] = {
  "H", "h", "help", "hel", "hlp", "-he", nullptr };

static const char* _check_[] = {
  "ch", "che", "chec", "check", nullptr };

static const char* _csv_[] = {
  "CS", "cs", "csv", nullptr };

static const char* _xml_[] = {
  "XM", "xm", "xml", "XML", nullptr };

static const char* _pcf_[] = {
  "PC", "pc", "pcf", nullptr };

static const char* _blif_[] = {
  "BL", "blif", nullptr };

static const char* _json_[] = {
  "JS", "js", "jsf", "json", "port_info", "port_i", "PI", nullptr };

static const char* _output_[] = {
  "O", "o", "ou", "OU", "out", "outp", "output", nullptr };

static const char* _trace_[] = {
  "TR", "trace", "tr", "tra", nullptr };

static const char* _test_[] = {
  "TE", "TC", "test", "te", "tc", "tes", "tst", "test_case", "test_c", nullptr };

#ifdef RSBE_UNIT_TEST_ON

  const char* _uni1_[] = {
    "U1", "Unit1", "unit1", "un1", "uni1", nullptr };
  const char* _uni2_[] = {
    "U2", "u2", "Unit2", "unit2", "un2", "uni2", nullptr };
  const char* _uni3_[] = {
    "U3", "u3", "Unit3", "unit3", "un3", "uni3", nullptr };
  const char* _uni4_[] = {
    "U4", "unit4", "un4", "uni4", nullptr };
  const char* _uni5_[] = {
    "U5", "unit5", "un5", "uni5", nullptr };
  const char* _uni6_[] = {
    "U6", "u6", "Unit6", "unit6", "un6", "uni6", nullptr };
  const char* _uni7_[] = {
    "U7", "u7", "Unit7", "unit7", "un7", "uni7", nullptr };
...
// non-null string
inline static const char* nns(const char* s) noexcept {
  return s ? s : "(NULL)";
}
...
bool rsOpts::sprintFiles(const char* subdir, const char* stem) noexcept
{
    ...
    if (not input_file_exists(pcfFile_))
        pcfFile_[0] = 0;
...
bool rsOpts::set_PINC_test() noexcept
{
    ...
    cout << "       setupTest()  test-ID: " << test_id_
         << "  subdir: " << subdir << endl;
